...
class ResenaCancion(models.Model):
    """Modelo para reseñas de canciones"""
    resena_cancion_id = models.AutoField(primary_key=True)
    usuario = models.ForeignKey(Usuario, on_delete=models.CASCADE, db_column='usuario_id')
    cancion = models.ForeignKey(Canciones, on_delete=models.CASCADE, db_column='cancion_id')
...
class ReaccionResenaCancion(models.Model):
    """Modelo para likes/dislikes en reseñas de canciones"""
    usuario = models.ForeignKey(Usuario, on_delete=models.CASCADE, db_column='usuario_id')
    resena_cancion = models.ForeignKey(ResenaCancion, on_delete=models.CASCADE, db_column='resena_cancion_id')
